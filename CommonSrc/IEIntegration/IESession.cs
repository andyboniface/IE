...
namespace IE.CommonSrc.IEIntegration
{
    public class IESession
    {
        ...
        private const string SEARCH_URL_START = "https://www.illicitencounters.com/search/results/mode/online/gender/";
        ...
        {
            string searchUrl = SEARCH_URL_START;
